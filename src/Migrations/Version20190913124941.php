 ...
 */
final class Version20190913124941 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE SEQUENCE user_selection_list_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        ...
        $this->addSql('CREATE TABLE user_selection_list (id INT NOT NULL, user_uid VARCHAR(50) NOT NULL, title VARCHAR(250) NOT NULL, position INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE user_selection_document (id INT NOT NULL, list_id INT DEFAULT NULL, title VARCHAR(250) NOT NULL, author VARCHAR(250) NOT NULL, document_type VARCHAR(50) DEFAULT NULL, creation_date TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, permalink VARCHAR(255) NOT NULL, url VARCHAR(255) NOT NULL, comment TEXT DEFAULT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_A38819C53DAE168B ON user_selection_document (list_id)');
        $this->addSql('CREATE TABLE search_history (id VARCHAR(40) NOT NULL, title VARCHAR(250) NOT NULL, query_string TEXT, PRIMARY KEY(id))');
        ...
        $this->addSql('ALTER TABLE user_selection_document ADD CONSTRAINT FK_A38819C53DAE168B FOREIGN KEY (list_id) REFERENCES user_selection_list (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user_selection_document DROP CONSTRAINT FK_A38819C53DAE168B');
        ...
        $this->addSql('DROP SEQUENCE user_selection_list_id_seq CASCADE');
        ...
        $this->addSql('DROP TABLE user_selection_list');
